(function ($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function (opts) {
        ...
        this.each(function () {
            ...
            let counter = 0;
            let dragbox = $(
                `<div class="imageuploadify well"><div class="imageuploadify-overlay"><i id="zone" class="uil uil-cloud-upload"></i></div><div class="imageuploadify-images-list text-center"><i id="zone" class="uil uil-cloud-upload"></i><button type="button"class="btn btn-default">ou sélectionnez le fichier à télécharger</button></div></div>`
            );
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(
                    `<div class='imageuploadify-container'><button type='button'class='btn btn-danger'>X</button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`
                );
