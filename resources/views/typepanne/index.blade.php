                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-3">
                                    @can('create', App\Models\Configuration::class)
                                        <a href="{{ route('TypePanne.create') }}" class="btn btn-primary">Créer</a>
                                    @endcan
                                </div>

                                <div class="col-6">
                                    <h3 style=" text-align: center">Type Panne</h3>
                                </div>

                                <div class="col-3">
                                    @can('restore', App\Models\Configuration::class)
                                        <a style="float: right" href="{{ route('TypePanne.deleted') }}"
                                        ...
                                        <tr>
                                            ...
                                            @can('update', App\Models\Configuration::class)
                                                <td> <a class="btn btn-sm btn-primary rounded-pill"
                                                        href="{{ route('TypePanne.edit', [$type->id]) }}">
                                            ...
                                            @can('delete', App\Models\Configuration::class)
                                                <td>
                                                    @if ($type->id != 1)
                                                        <form action="{{ route('TypePanne.destroy', [$type->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
